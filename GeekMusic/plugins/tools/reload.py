...
from GeekMusic.utils.database import get_authuser_names, get_cmode
from GeekMusic.utils.decorators import (ActualAdminCB, AdminActual,
                                         language)
from GeekMusic.utils.formatters import alpha_to_int
...
async def restartbot(client, message: Message, _):
    ...
    try:
        db[message.chat.id] = []
        await Geek.stop_stream(message.chat.id)
    except:
        pass
