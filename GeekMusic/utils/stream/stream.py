...
import config
from GeekMusic import Carbon, YouTube, app
from GeekMusic.core.call import Geek
from GeekMusic.misc import db
from GeekMusic.utils.database import (add_active_chat,
                                       add_active_video_chat,
                                       is_active_chat,
                                       is_video_allowed, music_on)
from GeekMusic.utils.exceptions import AssistantErr
from GeekMusic.utils.inline.play import (stream_markup,
                                          telegram_markup)
from GeekMusic.utils.inline.playlist import close_markup
from GeekMusic.utils.pastebin import Geekbin
from GeekMusic.utils.stream.queue import put_queue, put_queue_index
...
async def stream(
    ...
    if forceplay:
        await Geek.force_stop_stream(chat_id)
