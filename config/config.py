...
)  # Example:- https://t.me/TheGeek
SUPPORT_GROUP = getenv(
    "SUPPORT_GROUP", None
)  # Example:- https://t.me/GeekSupport
...
MUST_JOIN = getenv("MUST_JOIN", "JuiceChannelUpdate")
...
# You'll need a Pyrogram String Session for these vars. Generate String from our session generator bot @GeekStringBot
